...
fun Context.writeStringPreference(key: String, value: String?) {
    getSharedPreferences("yuihub.preferences", Context.MODE_PRIVATE).edit {
        putString(key, value)
    }
}

fun Context.readStringPreference(key: String, defaultValue: String? = null): String? {
    return getSharedPreferences("yuihub.preferences", Context.MODE_PRIVATE).getString(key, defaultValue)
}
...
fun Context.readBooleanPreference(key: String, defaultValue: Boolean = false): Boolean {
    return getSharedPreferences("yuihub.preferences", Context.MODE_PRIVATE).getBoolean(key, defaultValue)
}
